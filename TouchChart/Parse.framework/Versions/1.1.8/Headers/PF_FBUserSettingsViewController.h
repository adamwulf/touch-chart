...
/*!
 ...
 @abstract
 The `PF_FBUserSettingsDelegate` protocol defines the methods called by a <PF_FBUserSettingsViewController>.
 */
@protocol PF_FBUserSettingsDelegate <PF_FBViewControllerDelegate>
...
/*!
 @class PF_FBUserSettingsViewController
 
 @abstract
 The `PF_FBUserSettingsViewController` class provides a user interface exposing a user's
 ...
 bundle. In order to use `PF_FBUserSettingsViewController`, drag the `PF_FBUserSettingsViewResources.bundle`
 from the SDK directory into your Xcode project.
 */
@interface PF_FBUserSettingsViewController : PF_FBViewController
