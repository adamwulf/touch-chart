...
#import "PF_FBSession.h"
    ...
    #pragma message ("warning: using PF_FBTestSession, which is designed for unit-testing uses only, in non-DEBUG code -- ensure this is what you really want")
#endif
...
/*!
 @class PF_FBTestSession
 
 @abstract
 Implements an PF_FBSession subclass that knows about test users for a particular
 ...
 currently in use by another PF_FBTestSession, just use that user. If no such user is available,
 ...
 created, and it will be automatically deleted when the PF_FBTestSession is closed.
 ...
 */
@interface PF_FBTestSession : PF_FBSession
